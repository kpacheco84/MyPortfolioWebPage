...
const carousel = [
  {
    ...
    header: 'Login Page',
    desc:
      ' Login screen allows customer to login securely if they are currently not authenticated.',
  },
  {
    image: ref_sidenav,
    header: 'Navigation Bars',
    desc:
      ' Top Nav show the name of the employee who has successfully logged in. Side navigation hamburger menu appears allowing the employee to toggle the side navigation menu.',
  },
  {
  ...
  },
  {
    ...
    header: 'Service Order Entry',
    desc:
      'Both the Entry and Exit ticket allows the employee to see a printable view of the job order detail. These same Tickets will be automatically emailed to the customers email address on file.',
  },
  {
  ...
  },
  {
    ...
    desc:
      'All service orders show in a table and allow quick click for detail view, allows filtering and the ability to take payments.',
  },
  {
    image: ref_joborderdetail,
    header: 'Service Order Detail',
    desc:
      'This screen allows the employee to see all the equipment detail in one single screen.',
  },
  {
    image: ref_joborderdetailsavealert,
    header: 'Service Order Detail',
    desc:
      'Alerts help insure the employee is prompted any important information.',
  },
  {
    image: ref_exitticket,
    header: 'Service Order Exit',
    desc:
      'The Service Order Exit screen allows the employee to view service order detail and balance information to take payments.',
  },
]
