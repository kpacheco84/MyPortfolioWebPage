...
import TableauEmbed from '../assets/TableauEmbed.PNG'
  ...
  const projects = [
    {
      ...
      tech: ['React', 'AWS S3', 'AWS Amplify', 'GraphQL'],
      github: '',
      run: '',
      pics: 'test',
      github_flag: false,
    ...
    },
    {
      ...
      desc: 'OOP Game',
      tech: ['React', 'Bootstrap', 'JQuery', 'AWS S3'],
...

    {
      ...
      tech: ['React', 'AWS S3', 'MongoDB Atlas', 'Express'],
    ...
    }*/,
    {
      ...
      desc: 'Tableau and React',
      tech: ['React', 'Tableau', 'AWS Amplify'],
      github: 'https://github.com/kpacheco84/tableau-embedded.git',
      run: 'https://master.d2xrwunqlc5u0l.amplifyapp.com/',
      pics: '',
      github_flag: true,
      run_flag: true,
      pics_flag: false,
  ...
  const renderCard = (card, index) => {
    ...
    return (
      <div className="p-3" id="projects">
        <Card className="project_cards" key={index}>
          <CardImg
            src={card.image}
          ...
          <Card.Footer
            style={{ backgroundColor: 'var(--dark_blue)', height: '75px' }}
          >
            {index === 0 ? (
              <FontAwesome
