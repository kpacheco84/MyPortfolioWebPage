...
const AboutMe = () => {
  return (
        ...
        <div>
        <Fade  duration ={3000}> 
        <h1 style={{ paddingTop: "40px", textAlign: "center" }}>About Me</h1>
        </Fade>
        </div>
      ...
      <div >
       <section>
          ...
          <p >
            ...
            this has made me an asset in the Tech Industry in that I
            ...
            well-rounded Full Stack Software Developer. 
